...
--
-- Host: localhost
-- Generation Time: Nov 05, 2014 at 06:08 AM
...
-- Database: `namuna`
--
CREATE DATABASE IF NOT EXISTS `namuna` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `namuna`;
...
(3, 'dshkfkjsdh', '                  hkjsdhjkfhs<br>', 'hkjdshfkjs', '2014-10-21 12:30:00', 'AilVH1.jpg');
...
(12, 'chharo1', 0, '2014-10-29 01:50:19', '            <br>', '0', NULL, NULL, NULL, '            <br>', 0, 0, 0, 0, 'CPtp3birdedu.png'),
(13, 'crop', 0, '2014-10-29 02:04:39', '      <br>', '0', NULL, NULL, NULL, '      <br>', 0, 0, 0, 0, 'Gr8Xgt.png');
...
(10, 'admin', 'hom nath', 'bagale', 'bhomnath@salyani.com.np', '21232f297a57a5a743894a0e4a801fc3', NULL, '2014-03-06 04:16:57', '64L3XB9ID5', '1', '0');
